    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonCompany.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                CursorAdapter adapter = new CursorAdapter(MainActivity.this,cursor, CursorAdapter.
                    ...
                    public void bindView(View view, Context context, Cursor cursor) {
                        ...
                        String firstName = cursor.
                                getString(cursor.getColumnIndex(DatabaseHelper.COL_FIRST_NAME));
                        String lastName = cursor.
                                getString(cursor.getColumnIndex(DatabaseHelper.COL_LAST_NAME));
                ...
                CursorAdapter adapter = new CursorAdapter(MainActivity.this,cursor,CursorAdapter.
                    ...
                    public void bindView(View view, Context context, Cursor cursor) {
                        ...
                        textView.setText(cursor.getString(cursor.
                                getColumnIndex(helper.COL_COMPANY)));
                    }
                };
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final View dialogLayout = inflater.inflate(R.layout.input_dialogue, null);
                builder.setView(dialogLayout);


                builder.setTitle("JoinsLab");
